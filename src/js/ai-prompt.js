...
function buildHexPromptContext(state, lang, userMsg) {
...
window.buildHexCompactSystemPrompt = function (state, lang, userMsg) {
  const ctx = buildHexPromptContext(state, lang, userMsg);
